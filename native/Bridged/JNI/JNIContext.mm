...
const std::vector<std::string> CACHABLE_CLASSNAMES = {
    "dev/kocken/nativebridge/item/GroupTouchBarItem",
    "dev/kocken/nativebridge/item/view/TouchBarView",
    "dev/kocken/nativebridge/item/view/TouchBarTextField",
    "dev/kocken/nativebridge/item/view/TouchBarButton",
    "dev/kocken/nativebridge/item/view/TouchBarScrubber",
    "dev/kocken/nativebridge/item/view/TouchBarSlider",
};
...
color_t JNIContext::CallColorMethod(JNIEnv* env, jobject target, const std::string& method) {
    ...
    jobject javaColor = JNIContext::CallObjectMethod(env, target, method, "dev/kocken/nativebridge/common/Color");
...
image_t JNIContext::CallImageMethod(JNIEnv* env, jobject target, const std::string& method) {
    ...
    jobject javaImage = JNIContext::CallObjectMethod(env, target, method, "dev/kocken/nativebridge/common/Image");
