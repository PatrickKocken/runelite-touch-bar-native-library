...
@implementation JavaTouchBarUtils
...
+(NSTouchBarItem*) touchBar:(NSTouchBar *)touchBar makeItemForIdentifier:(NSTouchBarItemIdentifier)identifier usingJavaTouchBar:(JavaTouchBar*)javaTouchBar {
    if(javaTouchBar == nil) {
        return nil;
    }
    
    for(JavaTouchBarItem *item in [javaTouchBar getTouchBarItems]) {
